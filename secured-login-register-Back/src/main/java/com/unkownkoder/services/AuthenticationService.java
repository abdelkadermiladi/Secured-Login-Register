...
public class AuthenticationService {
    ...
    public ApplicationUser registerUser(String username, String password, String gender){
        ...
        return userRepository.save(new ApplicationUser(0, username, encodedPassword, gender, authorities));
    }
